...
The true relationship is that age has a linear relationship and BMI has a U-shapred relationship.

We will assume that data has been appropriately examined, plotted and cleaned
